...
function Terms() {
  ...
  return (
    <>
      <div className='header-container-terms'>
        <div className='header-keyflix-terms'>
          <div className='header-logo-terms'>
            <img src="/public/keyflix.svg" alt="" width={30} height={30} id='keyflix-icon' />
            <h1 className='keyflix-title-terms' id='keyflix-title'>KeyFlix</h1>
          </div>
        </div>
      </div>
